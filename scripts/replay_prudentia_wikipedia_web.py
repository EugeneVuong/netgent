...
Reproduces the wikipedia.org web workload from "Prudentia: Findings of an Internet
Fairness Watchdog" (SIGCOMM '24, section 5.2; Table 1: BBRv1.0, >5 flows, mostly text):
...
Usage:
    uv run python scripts/replay_prudentia_wikipedia_web.py                 # 10 loads, 45 s apart
    uv run python scripts/replay_prudentia_wikipedia_web.py --gap-seconds 5
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            os.path.dirname(__file__), "workflow", "prudentia_wikipedia_web_workflow.json"
        ),
